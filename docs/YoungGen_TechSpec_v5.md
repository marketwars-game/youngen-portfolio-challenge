...
**Version:** YG-V5 (final rework — cut Awards step · champion reveal → real-teams-only ranking · mobile spoiler guard)
...
## Deployment
- **Repo:** https://github.com/marketwars-game/youngen-portfolio-challenge (public) · tags: `YG-V0` → `YG-V1` → `YG-V2` → `YG-V3` → `YG-V4` → **`YG-V5`**
...
| **YG-V6** | 6-team display layout + full EN sweep + YoungGen QR link + dormant cleanup (FinalMC 5-lessons PiggyBank) → dry-run | ถัดไป |
